    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul className="text-red-500 font-medium">
                        <li className="mb-4">
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-red-900 uppercase">Follow us</h2>
                    <ul className="text-red-500 font-medium">
                        <li className="mb-4">
                            <a
                                href="https://github.com/JeneshRaj"
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-red-500 sm:text-center">
                © 2024
                <a href="https://652181261e9f4612e7827a5b--velvety-caramel-f58359.netlify.app//" className="hover:underline">
                    JeneshRajUdas
                </a>
                . All Rights Reserved.
            </span>
            <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                <Link to="#" className="text-red-500 hover:text-gray-900">
                    <svg
                        className="w-4 h-4"
                        aria-hidden="true"
